...
### Outer-operation parallel variant (`mtpndd_nqueens_parallel_benchmark`)
...
| N | 1 worker | 6 workers | vs serial (6w) |
|---|---:|---:|---:|
| 10 | 0.220 s | 0.080 s | **−14%** |
| 11 | 1.093 s | 0.295 s | **−14%** |
| 12 | 5.804 s | 1.473 s | **−4%** |
| 13 | 33.66 s | 8.23 s | **−4%** |

All figures from the 2026-04-22 sweep. Raw data: `bench_results_{serial,parallel}_{release,pgo}_*.tsv`.
