...
#ifdef __cplusplus
#define LACE_REGISTER
#else
#define LACE_REGISTER register
#endif
...
/**
 * Compatibility wrapper for older Lace API (lace_start/lace_stop).
 * Starts Lace with the current thread as worker 0.
 */
